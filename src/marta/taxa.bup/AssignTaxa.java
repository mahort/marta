...
// -I (capital-i) provides the gis to the program so that I can use the taxonomy database.
//
			/*StringBuffer base = new StringBuffer( " -p blastn -d nt -I -v ").append( 
					String.valueOf(tophits)).append( " -b ").append( String.valueOf(tophits)).append( 
					" -a ").append( cores ).append(" -n T -W ").append( wordsize ).append(" -m 6 ");*/
